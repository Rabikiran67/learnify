...
const LoginPage = () => {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto bg-white rounded-2xl shadow-2xl flex">
      ...
      <div className="w-full md:w-1/2 p-8 md:p-12">
        ...
        <form onSubmit={submitHandler} className="space-y-5">
          ...
          <div>
            <button type="submit" disabled={isLoading} className="w-full py-3 px-4 bg-primary-light text-white font-semibold rounded-md shadow-md hover:bg-opacity-90 disabled:bg-opacity-70">
              {isLoading ? 'Signing In...' : 'Log In'}
            </button>
          </div>
        </form>
        <div className="mt-6 text-center">
          <p className="text-sm">Don't have an account? <Link to="/register" className="font-medium text-primary-light hover:underline">Create an account</Link></p>
        </div>
